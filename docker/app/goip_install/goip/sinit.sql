...
LOCK TABLES `USSD` WRITE;
/*!40000 ALTER TABLE `USSD` DISABLE KEYS */;
/*!40000 ALTER TABLE `USSD` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `auto` VALUES (0,'','',0,'','',15,'','');
...
-- Dump completed on 2012-05-07  7:32:18
