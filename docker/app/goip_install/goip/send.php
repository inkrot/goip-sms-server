...
if($_GET['action']=="modify"){
	...
	$buttoninfo = <<<EOT
<td align="center"><input type="submit" name="submit2" value="修改定时发送" class="submit" onClick="return check2();"><br> <input type="text" name="datehm"  readOnly onClick="SelectDate(this,'yyyy-MM-dd hh:mm')" value="{$crontime}"><br>设定时间</td>
EOT;
	
}
else {
	$buttoninfo = <<<EOT
<td align="center"  valign="top" style="padding-top:65px;"><input type="submit" name="submit1" value="发送" class="submit"> <br><br><br> <input type="submit" name="submit2" value="定时发送" class="submit" onClick="return check2();"><br> <input type="text" name="datehm"  readOnly onClick="SelectDate(this,'yyyy-MM-dd hh:mm')" value="{$crontime}"><br>设定时间</td>
EOT;
}
...
<tr id="row_customfield_operator">
  <td class="field-label"><label>服务商</label></td>
  <td>                                                                                                            
...
if(!$_GET['goipid'] || $myaction == "modify") $op="<option value='0'>DEFAULT</option>";
$js.=<<<EOT
